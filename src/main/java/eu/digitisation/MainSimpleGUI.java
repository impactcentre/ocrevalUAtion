            ...
            if (checked) {
                ...
                if (files[3] != null) {
                    try {
                        ...
                        CharFilter filter = (files[2] == null)
                                ? new CharFilter()
                                : new CharFilter(files[2]);
                        Report report = new Report(batch, null, null, filter);
                        ...
                        Logger.getLogger(MainSimpleGUI.class.getName()).log(Level.SEVERE, null, ex);
